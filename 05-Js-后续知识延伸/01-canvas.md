...
- *ctx.textBaseline*：设置字体垂直对齐方式（*top、hanging、middle、alphabetic、ideographic、bottom*）
  ...
  ![](./assets/canvas-textBaseline.png)
...
![](./assets/canvas-moveto-lineto.png)
...
![](./assets/canvas-radialGradient-1.png)
