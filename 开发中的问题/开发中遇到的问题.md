...
'/ccp-api/ccp-auth-server/auth': {

​    target: 'http://172.20.230.161:8084',

​    changeOrigin: true,

​    pathRewrite: { '^/ccp-api/ccp-auth-server': '' }

   },



#### 7.element-ui按钮(按下后，颜色应该复原)
...
https://www.cnblogs.com/doude/p/11405638.html
